...
public class Jwork {
    ...
    public static void main(String[] args) {
        ...
        try{
            DatabaseJob.addJob(new Job(DatabaseJob.getLastId()+1, "Bryan1", DatabaseRecruiter.getRecruiterById(1), 8000, JobCategory.WebDeveloper));
            DatabaseJob.addJob(new Job(DatabaseJob.getLastId()+1, "Bryan2", DatabaseRecruiter.getRecruiterById(2), 8008, JobCategory.WebDeveloper));
            DatabaseJob.addJob(new Job(DatabaseJob.getLastId()+1, "Bryan3", DatabaseRecruiter.getRecruiterById(3), 8080, JobCategory.BackEnd));
            DatabaseJob.addJob(new Job(DatabaseJob.getLastId()+1, "Bryan4", DatabaseRecruiter.getRecruiterById(3), 8800, JobCategory.FrontEnd));

...
public class Jwork {
        ...
        public static void main(String[] args) {
            ...
            try{
                DatabaseJob.addJob(new Job(DatabaseJob.getLastId()+1, "Bryan1", DatabaseRecruiter.getRecruiterById(1), 80000, JobCategory.DataAnalyst));
            }catch (RecruiterNotFoundException error){
                System.out.println(error.getMessage());
            }
            try{
                DatabaseJob.addJob(new Job(DatabaseJob.getLastId()+1, "Bryan2", DatabaseRecruiter.getRecruiterById(2), 80000, JobCategory.DataAnalyst));
            }catch (RecruiterNotFoundException error){
                System.out.println(error.getMessage());
            }
            try{
